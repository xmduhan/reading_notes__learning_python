...
def render(slide,mainTitle,titles,dataFrames,drawers):
    ...
    titleBars = [titleBar1,titleBar2,titleBar3,titleBar4]    
    ...
    shape3 = shapes.AddOLEObject(chartBeginV1, chartBeginH2, chartWidth, chartHeight,'Excel.Chart')
    shape4 = shapes.AddOLEObject(chartBeginV2, chartBeginH2, chartWidth, chartHeight,'Excel.Chart')
    shapeList = [shape1,shape2,shape3,shape4]
