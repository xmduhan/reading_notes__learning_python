...
chart1 = shapes.AddShape(msoShapeRectangle, chartBeginV1, chartBeginH1, chartWidth, chartHeight)
chart2 = shapes.AddShape(msoShapeRectangle, chartBeginV2, chartBeginH1, chartWidth, chartHeight)
chart3 = shapes.AddShape(msoShapeRectangle, chartBeginV1, chartBeginH2, chartWidth, chartHeight)
chart4 = shapes.AddShape(msoShapeRectangle, chartBeginV2, chartBeginH2, chartWidth, chartHeight)
#%%
titleBar1.TextFrame.TextRange.Text = u'呵呵'.encode('gbk')
#%%
